sap.ui.define([
	...
	return BaseController.extend("FabFinV3.c.View2", {
		...
		handleUpload: function(oEvent, key) {
								...
								return $.proxy(
									function(e) {
										...
										img.onload = function() {
											...
											var compressedDataURL = canvas.toDataURL('image/jpeg', 0.7); // Adjust the quality (0.7 = 70%)

											// Display the compressed image
											//	that.byId("idImg").setSrc(compressedDataURL);

											that.iModel.getData()[key] = compressedDataURL;
											//	that.byId("idImg").setSrc(that.iModel.getData()[key]);
										}
